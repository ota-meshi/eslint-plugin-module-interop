...
declare module "@eslint-community/eslint-utils" {
  ...
  export function getStringIfConstant(
    node: TSESTree.Node,
    initialScope?: TSESListScope | Scope.Scope | null | undefined,
  ): string | null;
  ...
  export class ReferenceTracker {
    public constructor(
      globalScope: TSESListScope | Scope.Scope,
      options?:
        | {
    ...
    public iterateGlobalReferences<Info = unknown>(
      traceMap: TraceMap<Info>,
    ): IterableIterator<Reference<Info>>;

    public iterateCjsReferences<Info = unknown>(
      traceMap: TraceMap<Info>,
    ): IterableIterator<Reference<Info>>;

    public iterateEsmReferences<Info = unknown>(
      traceMap: TraceMap<Info>,
    ): IterableIterator<Reference<Info>>;
  }
  type TraceMap<Info = unknown> = {
    [READ]?: Info;
    [CALL]?: Info;
    [CONSTRUCT]?: Info;
    [key: string]: TraceMap<Info> | undefined;
  };
  type Reference<Info = unknown> = {
    node: TSESTree.Node;
    path: string[];
    type: ReferenceType;
    info: Info;
